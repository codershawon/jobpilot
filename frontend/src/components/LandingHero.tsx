...
export default function LandingBanner({ onFileUpload, loading }: LandingBannerProps) {
  ...
  return (
    <section className="relative w-full pt-4 pb-12 overflow-hidden">
      ...
      <div 
        aria-hidden="true" 
        className="pointer-events-none absolute -top-24 left-1/4 w-[480px] h-[320px] bg-cyan-500/10 blur-[120px] rounded-full -z-10" 
      />
      <div 
        aria-hidden="true" 
        className="pointer-events-none absolute top-16 right-4 w-[380px] h-[280px] bg-sky-500/10 blur-[130px] rounded-full -z-10" 
      />
      ...
      <Container>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-5 text-left">
            ...
            <div className="pt-1 w-full max-w-xl">
              ...
              >
                ...
                <div className="absolute inset-x-8 top-0 h-[1px] bg-gradient-to-r from-transparent via-cyan-500/40 to-transparent" />
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  ...
                  <button
                    type="button"
                    className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 to-sky-600 hover:from-cyan-400 hover:to-sky-500 text-slate-950 font-bold text-xs shadow-sm shadow-cyan-500/20 group-hover:shadow-cyan-500/40 transition-all shrink-0 active:scale-95"
                  >
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-2xl bg-gradient-to-b from-slate-800 to-slate-900/60 p-[1px] shadow-2xl shadow-cyan-950/40">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-10 pt-6 border-t border-slate-800/60">
          ...
          <div className="flex items-center gap-3 p-3.5 rounded-xl bg-slate-900/30 border border-slate-800/60 hover:border-slate-700/80 transition-all">
            <div className="p-2 rounded-lg bg-teal-950/60 text-teal-400 shrink-0">
